...
exports.toolSchemas = [
    {
        name: 'grok_delegate',
        description: 'Delegate exploration, planning, diagnostics, or optional implementation work to Grok Build.',
        inputSchema: {
            type: 'object',
            properties: runProperties({
                allowWritesDescription: 'Allow Grok to modify files inside workspaceRoot. Defaults to false.'
            }),
    ...
    },
    {
        ...
        description: 'Ask Grok Build to use its native image/Imagine capability and save validated image artifacts.',
        inputSchema: {
            type: 'object',
            properties: {
                prompt: {
                ...
                outputDir: {
                    type: 'string',
                    description: 'Optional output directory inside workspaceRoot. Defaults to .codex-grok-bridge/image.'
                },
                aspectRatio: {
                    type: 'string',
    ...
    },
    {
        ...
        description: 'Ask Grok Build to use its native video generation capability and save validated video artifacts.',
        inputSchema: {
            type: 'object',
            properties: {
                prompt: {
                ...
                outputDir: {
                    type: 'string',
                    description: 'Optional output directory inside workspaceRoot. Defaults to .codex-grok-bridge/video.'
                },
                aspectRatio: {
                    type: 'string',
...
function capabilityCommonProperties() {
    ...
    return {
        ...
        disableWebSearch: {
            ...
            description: 'Disable Grok web search/fetch tools. grok_search rejects true because search requires web tools.'
        }
    };
}
